...
public class LinkController {
    ...
    public String query(@RequestParam("name")String name, @RequestParam("age")int age, Model model){
    ...
    public String pathMapping(@PathVariable("name")String name, @PathVariable("age")int age, Model model){
        model.addAttribute("info", name + "" + age);
        return "/link/query_result";
